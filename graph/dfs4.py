...
e2 = g.insert_edge(v3,v1,20)
e3 = g.insert_edge(v1,v4,30)
e4 = g.insert_edge(v3,v2,40)
e5 = g.insert_edge(v2,v3,50)
#e6 = g.insert_edge(v1,v4,60)
e7 = g.insert_edge(v4,v3,70)
e8 = g.insert_edge(v3,v4,80)
...
def dfs1(g,v,dic):
	for e in g.incident_edge(v,outgoing=False):
		u = e.opposite(v)
		if u not in dic:
			dic[u] = e
			dfs(g,u,dic)
...
#path = construct_path1(v1,v4,dude)
#for v in path:
#	print v
